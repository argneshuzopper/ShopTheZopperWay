...
public class TabletsSTZWByMutilUseCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("TabletsSTZWByMultiUse");
			...
			endTestCase("TabletsSTZWByMutilUse");

		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "TabletsSTZWByMultiUse");
			throw(e);

...
public class TabletsSTZWByVideosCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("TabletsSTZWByVideos");
			...
			endTestCase("TabletsSTZWByVideos");

		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "TabletsSTZWByVideos");
			throw(e);
		}

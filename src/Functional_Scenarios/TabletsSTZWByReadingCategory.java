...
public class TabletsSTZWByReadingCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("TabletsSTZWByReading");
			...
			endTestCase("TabletsSTZWByReading");

		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "TabletsSTZWByreading");
			throw(e);
		}

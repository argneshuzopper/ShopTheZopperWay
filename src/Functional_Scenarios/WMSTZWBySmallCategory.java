...
public class WMSTZWBySmallCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("WMSTZWBySmallCategory");
			...
			endTestCase("WMSTZWBySmallCategory");
		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "WMSTZWBySmallCategory");
			throw (e);
		}

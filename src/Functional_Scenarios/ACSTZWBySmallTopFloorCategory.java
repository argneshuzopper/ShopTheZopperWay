...
public class ACSTZWBySmallTopFloorCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try{
			startTestCase("ACSTZWBySmallCategoryTopFloor");
			...
			endTestCase("ACSTZWBySmallcategoryTopFloor");
		}catch(Exception e){
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "ACSTZWBySmallCategory");
			throw(e);
		}

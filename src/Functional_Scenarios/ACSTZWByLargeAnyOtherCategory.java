...
public class ACSTZWByLargeAnyOtherCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("ACSTZWByLargeAnyOtherCategory");
			...
			endTestCase("ACSTZWByLargeAnyOtherCategory");
		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "ACSTZWByLargeAnyOtherCategory");
			throw (e);
		}

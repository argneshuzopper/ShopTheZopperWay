...
public class WMSTZWByMediumCategory extends BaseTest{

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("WMSTZWByMediumCategory");
			...
			endTestCase("WMSTZWByMediumCategory");
		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "WMSTZWByMediumCategory");
			throw (e);
		}

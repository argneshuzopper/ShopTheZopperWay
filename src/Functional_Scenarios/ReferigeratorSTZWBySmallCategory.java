...
public class ReferigeratorSTZWBySmallCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try {
			startTestCase("ReferigeratorSTZWBySmallCategory");
			...
			endTestCase("ReferigeratorSTZWBySmallCategory");
		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "ReferigeratorSTZWBySmallCategory");
			throw (e);
		}

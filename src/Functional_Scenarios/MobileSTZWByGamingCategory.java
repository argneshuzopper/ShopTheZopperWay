...
//By Gaming Filter by skipping budget

@SuppressWarnings("deprecation")
public class MobileSTZWByGamingCategory extends BaseTest {
	...
	public void executeTestCase() throws Exception {
		try {
			...
			startTestCase("MobileSTZWByGaming");
			...
			waitforpresenceOfElement("SKIP");
			// wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.FrameLayout /android.view.View /android.view.View /android.view.View /android.view.View[2]")));
			...
			Assert.assertTrue(findElementByXpath(
					App_Constants.STZWSecondMobileproduct_text).isEnabled());
			info("seconf assertion verification");
			endTestCase("MobileSTZWByGaming");
		} catch (Exception e) {
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "MobileSTZWByGaming");
			throw (e);
		}

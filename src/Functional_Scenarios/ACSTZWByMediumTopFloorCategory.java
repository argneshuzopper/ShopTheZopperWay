...
public class ACSTZWByMediumTopFloorCategory extends BaseTest {

	@Override
	@Test
	public void executeTestCase() throws Exception {
		try{
			startTestCase("ACSTZWByMediumTopFloorCategory");
			...
			endTestCase("ACSTZWByMediumcategoryTopFloor");
		}catch(Exception e){
			System.out.println(e.getMessage());
			takeSnapShot("D:\\takeScreenshots", "ACSTZWByMediumTopFloorCategory");
			throw(e);
		}
